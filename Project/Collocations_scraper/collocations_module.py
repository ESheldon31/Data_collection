...
class CollocationsScraper(Scraper):
    ...
    def collect_info(self, list_words):
        ...
        coll_data = self.create_empty_dataclass()
        
        coll_data.adj_phrases = self.get_frequency_and_phrases(
            word_class='adj', 
            url_mode='', 
            tag='p', 
            attribute='class', 
        ...
        coll_data.adj_rank_word_frequency = self.get_frequency_and_phrases(
            word_class='adj', 
        ...
        coll_data.verb_phrases = self.get_frequency_and_phrases(
            word_class='v', 
            url_mode='', 
            tag='p', 
            attribute='class', 
        ...
        coll_data.verb_rank_word_frequency = self.get_frequency_and_phrases(
            word_class='v', 
            url_mode='?mode=frequency', 
            tag='div', 
            attribute='class', 
        ...
        id_lists = self.create_id(list_words)
